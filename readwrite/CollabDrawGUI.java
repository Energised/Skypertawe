...
public class CollabDrawGUI extends GUI {
    ...
    */
	public CollabDrawGUI3() throws Exception {
		super();
		loadElements();
	}
	...
	private void loadElements() {
        DrawingPanel drawPanel = new DrawingPanel(/**m_firstAccount, m_secondAccount*/);
        ...
        particleBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                drawPanel.setDrawTool("Particle Trace");
            }
        });
        ...
        blueBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                drawPanel.setElemColor(Color.BLUE);
            }
        });
        ...
        blackBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                drawPanel.setElemColor(Color.BLACK);
            }
        });
        ...
        redBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                drawPanel.setElemColor(Color.RED);
            }
        });
        ...
        greenBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                drawPanel.setElemColor(Color.GREEN);
            }
        });
		...
		yellowBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                drawPanel.setElemColor(Color.YELLOW);
            }
        });
		 ...
		 */
		drawPanel.add(label);
        drawPanel.add(lineBtn);
        drawPanel.add(particleBtn);
        drawPanel.add(blueBtn);
        drawPanel.add(blackBtn);
        drawPanel.add(redBtn);
        drawPanel.add(greenBtn);
		drawPanel.add(yellowBtn);
        this.add(drawPanel);
